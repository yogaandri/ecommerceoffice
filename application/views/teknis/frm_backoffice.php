                        ...
                        <div class="col-md-12">
                            <div class="tabs tabs-primary">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li>
                                        <a href="<?=base_url();?>teknis/backoffice"><i class="fa  fa-sort-alpha-desc"></i> List Data</a>
                                    </li>
                                </ul>
                                <div class="tab-content">
                                    <div id="popular1" class="tab-pane active">
                                        <!-- Isi Tab Pertama -->
                                        <form method="post" action="" enctype="multipart/form-data" name="frm_backoffice" id="frm_backoffice">
                                            <!-- Pembatas Row -->
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" placeholder="" title="" data-toggle="tooltip" id="id_karyawan" name="id_karyawan"
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        data-trigger="hover" class="form-control" data-original-title="Masukkan permasalahan">
                                                    </div>
                                                </div>
                                            </div>
											<!-- Pembatas Row -->
											...
											<div class="row">
												<div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="tgl_keluhan" name="tgl_keluhan" data-plugin-datepicker data-date-format="yyyy-mm-dd" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
											</div>
